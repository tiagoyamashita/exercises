...
public class PythonItemRelayApiController {
  ...
  /** AJAX: calls Python {@code POST /api/items} with JSON {@code {"name": "…"}}. */
  @PostMapping(
      value = "/add-via-python",
      consumes = MediaType.APPLICATION_JSON_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public Map<String, Object> addViaPythonJson(@Valid @RequestBody CreateItemRequest body) {
